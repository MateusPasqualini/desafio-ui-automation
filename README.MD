...
|-------------------------------|-----------------|------------------|-------------------|--------------------|
| Entradas                      |        1        |         2        |         3         |          4         |
| Valor minimo >20 para aplicão |       não       |        Sim       |        Sim        |         Sim        |
...
Resultado Esperado: Deve carregar uma nova página exibindo o valor acumulado de acordo com o número de meses inseridos, e uma lista com outras opções de simulações exibindo tempo em meses e valores possíveis.
...
Quando aplico um valor entre de R$20,00 e R$9999999.00 
E  insiro o número de meses que desejo guardar
Então deve ser efetuada a simulação e deve exibir o valor acumulado de acordo com os anos inseridos, convertidos para meses
...
No Campo: “Por quanto tempo você quer poupar?” inserir um valor entre 1 e 999
Clicar no botão “Simular
Resultado Esperado: Deve carregar uma nova página exibindo o valor acumulado de acordo com o número de anos inseridos, convertidos para meses e uma lista com outras opções de simulações exibindo tempo em meses e valores possíveis.
...
irão rodar os testes. Para alterar o tipo de parelilzação mude o atributo "parallel" e
 para alterar o número de threads mude o atributo "thread-count" dentro da tag < test>
